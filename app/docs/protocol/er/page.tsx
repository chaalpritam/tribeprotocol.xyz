...
export const metadata: Metadata = {
  ...
  description:
    "Optimistic sequencer that confirms follow/unfollow in <50ms and batches up to 50 ops per Solana transaction on a 10-second settlement cadence.",
};
    ...
    <div className="max-w-3xl">
      ...
      <div className="space-y-16">
        <section>
          ...
          <div className="p-6 rounded-2xl border border-zinc-200 bg-zinc-50">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="w-2 h-2 rounded-full bg-green-500" />
                <p className="text-sm text-zinc-600">Frontend receives &ldquo;Success&rdquo; and updates UI immediately.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-600 mb-6 leading-relaxed">
            Pending operations flush to Solana L1 on a 10-second cadence (<code className="font-mono text-xs px-1 py-0.5 bg-zinc-100 rounded">SETTLEMENT_INTERVAL_MS=10000</code>). Reactions flush separately every 5 s in batches of up to 100.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl border border-zinc-200 bg-white">
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                Up to 50 follow/unfollow ops are bundled into one Solana transaction per tick. Configurable via <code className="font-mono text-xs px-1 py-0.5 bg-zinc-100 rounded">MAX_BATCH_SIZE</code>.
              </p>
            </div>
            <div className="p-6 rounded-2xl border border-zinc-200 bg-white">
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                The sequencer signs with the wallet at <code className="font-mono text-xs px-1 py-0.5 bg-zinc-100 rounded">~/.tribe/server-wallet.json</code>. The <code className="font-mono text-xs px-1 py-0.5 bg-zinc-100 rounded">social-graph</code> program rejects <code className="font-mono text-xs px-1 py-0.5 bg-zinc-100 rounded">follow_delegated</code>/<code className="font-mono text-xs px-1 py-0.5 bg-zinc-100 rounded">unfollow_delegated</code> from any other signer.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-6 text-sm text-zinc-600 leading-relaxed">
            &ldquo;The ER server is a convenience layer, not a gatekeeper. If the sequencer is unreachable, the SDK automatically falls back to direct L1 transactions.&rdquo;
          </div>
        </section>
      </div>
